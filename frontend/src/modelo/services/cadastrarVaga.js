...
document.addEventListener("DOMContentLoaded", () => {
    ...
    btnCadVaga.addEventListener("click", function () {
        ...
        const novaVaga = new vaga_1.Vaga(1, titulo, formato, local, descricaoVaga, competenciasVaga, qualificacoesVaga);
        salvarVagaNoLocalStorange(novaVaga);
    });
});
function salvarVagaNoLocalStorange(novaVaga) {
